...
#     print(image_title)
# get_image_title('http://img.mmjpg.com/2017/1137')
...
#     #构建图片具体地址的容器
    for i in range(1,38):
        ...
        response = requests.get(image_detail_link,headers).content
...
get_image_detail_website('http://img.mmjpg.com/2017/1137')
